...
| File | Purpose |
|------|---------|
| `yihai_v4.11.html` | Main training app (v4.11.13, single HTML file — CSS + markup + JS all inline, Supabase cloud sync) |
...
**当前版本：v4.11.13**。完整变更历史见 `docs/yihai_变更记录_CLAUDE参考.md`。
