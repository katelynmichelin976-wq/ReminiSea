...
| `tests/_pw_cross_device.js` | 跨设备同步（设备A练习→同步→设备B接收/review不被覆写/DP不跨设备/增量上传/暂停续传/水位迁移/Fix1-3 回归/mediaIncomplete/runMediaPhase await，39 断言；Easy 同步独立到 `_pw_easy_sync.js`） |
