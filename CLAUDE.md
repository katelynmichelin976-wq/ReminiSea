...
| File | Purpose |
|------|---------|
| `yihai_v5.4.html` | 主训练 App（v5.4.13，单 HTML 文件，Supabase 云同步） |
...
**当前版本：v5.4.13**（`yihai_v5.4.html`，线上版）。完整历史见 `docs/yihai_变更记录_CLAUDE参考.md`。

**v5.4.13：** 回滚 v5.4.11–v5.4.12 TTS 角色拆分代码，恢复 v5.4.10 原始状态，等待定位「日文界面+中文声音时选项朗读两次」根因
