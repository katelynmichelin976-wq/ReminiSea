...
| `tests/run_all.js` | 单元测试统一入口（6 套件，311 断言） |
...
**当前版本：v5.1.8**（`yihai_v5.1.html`，线上版）。完整历史见 `docs/yihai_变更记录_CLAUDE参考.md`。
...
Current counts: SRS 85, v4.4 98, v4.8 46, v4.9 48, i18n 27, voice 7（run_all.js 合计 311）；Playwright ui_smoke 41 / srs_e2e 14 / cloud_sync 26 / cross_device 11。
