...
| File | Purpose |
|------|---------|
| `yihai_v5.4.html` | 主训练 App（v5.4.14，单 HTML 文件，Supabase 云同步） |
...
**当前版本：v5.4.14**（`yihai_v5.4.html`，线上版）。完整历史见 `docs/yihai_变更记录_CLAUDE参考.md`。

**v5.4.14：** 恢复 v5.4.12 TTS 角色拆分代码（speak autoOnly 拆分 + speakSequence 修复）
